...
def is_eq(env,token,left,right):
...
def register_builtins(env):
    ...
    check_pair = (lambda arg,idx: is_pair(arg))
    check_list = (lambda arg,idx: is_list(arg))
    ...
    bind_builtin(env,'null?',(lambda env,tok,l: l == sdata.the_empty_list),check_arg_count=1)
